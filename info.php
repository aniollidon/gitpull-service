...
echo clean_lines(shell_exec("mysql --version"))."<br>";
  
echo "<b>Git branch </b> <br>";
chdir("/var/www/html/MP07");
echo clean_lines(file_get_contents(".aniol_gitpull/aniol_gitpull-branch.txt"))."<br>";

echo "<b>Git commit info </b> <br>";
echo clean_lines(file_get_contents(".aniol_gitpull/aniol_gitpull-gitlog.txt"))."<br>";

echo "<b>Git commit files </b> <br>";
echo clean_lines(file_get_contents(".aniol_gitpull/aniol_gitpull-files.txt"))."<br>";

echo "<b>Timer status </b> <br>";
echo clean_lines(shell_exec("systemctl list-timers aniol_gitpull.timer"), 3)."<br>";
  
echo "<b>Service status </b> <br>";
echo clean_lines(shell_exec("systemctl status aniol_gitpull --no-pager"))."<br>";

echo "<b>Service <a href='?fulllog'>log</a> </b> <br>";
echo clean_lines(shell_exec("tail /var/log/aniol_gitpull.log"))."<br>";
